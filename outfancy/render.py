...
'''
Falta.
Coso para setear comandos en config.
Pasar la config a JSON.
'''

def print_tupla():
    '''
    Concepto: Debe ser defensiva como el resto del programa, y debe imprimir tuplas en base a anchos
    estaticos.
    '''
    pass
